...
No text generated by Claude (code comments, docs, commit messages, PR descriptions, chat responses) should contain em dashes (—). Use a comma, period, colon, or parentheses instead.
